	...
	<div class="container white-popup-block">    	
            ...
            <ul class="noticias_transl row">
                ...
                <li class="noticia col-md-4">                                			  			
                    <a href="<?php the_permalink(); ?>" rel="<?php the_ID(); ?>" id="<?php echo $id_post;?>">                            
                        <?php 
                        //Banner
    ...
    jQuery(document).ready(function($){	
		...
		jQuery('.noticias_transl li a').bind('click',function(event){
			...
			function mostrarInfo(idInfo) {
				//var id_post = idInfo;
				var post_link = idInfo;
	
				$("#detalle_noticia").html('<div class="loader"></div>');
				$("#detalle_noticia").load(post_link);
				//alert(id_post);
